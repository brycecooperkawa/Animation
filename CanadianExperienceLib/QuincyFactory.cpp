 ...
 */
std::shared_ptr<Actor> QuincyFactory::Create(std::wstring imagesDir)
{
    shared_ptr<Actor> actor = make_shared<Actor>(L"Quincy");

    auto shirt = make_shared<ImageDrawable>(L"Coat", imagesDir + L"/black_coat.png");
    ...
    larm->SetColor(wxColour(62, 56, 66));
    ...
    rarm->SetColor(wxColour(62, 56, 66));
    ...
    lhand->SetColor(wxColour(104, 82, 68));
    ...
    rhand->SetColor(wxColour(104, 82, 68));
